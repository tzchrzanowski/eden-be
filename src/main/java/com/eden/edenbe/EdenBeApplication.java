...
//        System.out.println("\n" + referredUsersStr + "\n");
        ...
        /*
         * checking if getting all perfect-pairs of referred users works properly:
         * returns LONG id's of users that have the same direct-parent in node tree.
         * */
//        long userId = 2;
//        List<User> referredUsers = userService.getUsersByDirectReferral(userId);
//        List<User> referredPairs = userService.getPerfectPairsOfDirectReferral(referredUsers);
